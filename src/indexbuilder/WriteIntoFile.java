...
public class WriteIntoFile {
	...
	public static void WriteResult(String result) throws IOException{
		try{
			StringBuffer stb = new StringBuffer(EngineConfiguration.resultDir);
	...
	public static void WriteIndexOne(String indexOne, int i) throws IOException{
		try{
			StringBuffer stb = new StringBuffer(EngineConfiguration.subIndexDir);
	...
	public static void WriteIndexTwo(String indexTwo) throws IOException{
		try{
			StringBuffer stb = new StringBuffer(EngineConfiguration.indexDir);
			...
			String filePath = EngineConfiguration.finalPageIndexPath;
			FileWriter fileWriter = new FileWriter(filePath, true);
